...
- 2026-09-13: Top 5 商品切换改为品牌+类目联合索引；Amazon 图片、直接商品链接和真实 ASIN 同步变化。验证 All-Clad D3→D5 首项 ASIN 发生变化。评论记录按渠道加载最多 1,000 条，验证 Amazon 渠道显示 1–20 / 1,000 条；低于 500 的渠道保留实际可用量。
- 2026-09-13: 评论渠道选择栏从品牌卡片中独立并设为粘性固定。滚动至评论列表后实测栏位保持在视口顶部 78px，当前选中渠道持续可见；桌面与移动端根据顶部导航实际高度动态定位。
